    ...
    return(
        <footer id = "contact" className="h-50 px-8 flex items-center justify-between bg-[radial-gradient(circle_at_top_right,_#1e3a8a,_#020617_45%)] text-white border-b border-white/10 rounded-lg">
            <div className = " flex flex-col gap-2 items-center ">
                ...
                <span className = "text-white">Subhadeep Sardar</span>
                <span className = "text-white">Arkaprava Bhattacharya</span>
            </div>
            <div className = " flex flex-col gap-2 items-center ">
                <h2 className = "font-bold text-white text-3xl">Email</h2>
                <span className = "text-white">inform.suprio@gmail.com</span>
                <span className = "text-white">ssubhadeep500@gmail.com</span>
                <span className = "text-white">arkaprava181204@gmail.com</span>
            </div>
            <div className = " flex flex-col gap-2 items-center ">
